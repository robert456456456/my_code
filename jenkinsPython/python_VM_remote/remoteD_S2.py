          ...
          for vm in vmList:
              if vm.name in VmName[x] and vm.runtime.powerState in 'poweredOff':
                  try:
                    #print VmName[x]
                    #print row[1]
                    r = requests.get("http://192.168.0.14:7777/?Command=DeleteSnep&vm_name=" + VmName[x]+"&snapshot_name=" +row[1])
                    #print "http://192.168.0.14:7777/?Command=DeleteSnep&vm_name=" + VmName[x]+"&snapshot_name=" +row[1]
                    r.text
                  except:
