...
class Tipot_vm:
    ...
    def start(self):
        ...
        if section == 'Tipot_2':
            ...
            self.main()
        elif section == 'melishes':
            av = self.Check_a11_a22()
    ...
    def Check_a1_a2(self):
        array = []
        self.arr1 = self.get_m(fxml1, fjson1)
        self.arr2 = self.get_m(fxml2, fjson2)
        for av, result in self.sameerence(self.arr1, self.arr2):
            array.append(av.encode("utf-8"))
        return array

    def Check_a11_a22(self):
        array = []
        self.arr11 = self.get_m2(fxml1, fjson1)
        self.arr22 = self.get_m2(fxml2, fjson2)
        for av, result in self.sameerence(self.arr11, self.arr22):
            array.append(av.encode("utf-8"))
        return array
    ...
    def pars2(self, mashin, fxml, fjson):
        dom = minidom.parse(fxml)
        f = open(fjson, 'w')
        f.write(json.dumps(self.parse_element(dom), sort_keys=True, indent=4))
        f.close()
    ...
    def sameerence(self, array1, array2):
        ...
        for b in array2:
            ...
            if b == None:
                ...
                test_array2.append(b)


        #arrey1_sort = [r for r in array1 if r != None]
        print test_array1
        print test_array2
        array1 = test_array1
        array2 = test_array2
    ...
    def get_m2(self, fxml, fjson):
        ...
        for z1 in range(0, len(VmName_1)):
            b = self.pars2(VmName_1[z1], fxml, fjson)
            bob.append(b)
        return bob
    ...
    def remote_test(self, delay, server_ip, sever_login, server_pw, vm_list):
    ...
    def remote_count(self, resource_poole, snapshot_name, loopCounter, delay, server_ip, sever_login, server_pw,
                     path_vmn, defi):
        """
    ...
    def main(self):
        ...
        if defi == -1:
            ...
            self.remote_count(resource_pool1, snapshot_name, loopCounter, delay, server_ip, sever_login, server_pw,
                              path_vnm, defi)
