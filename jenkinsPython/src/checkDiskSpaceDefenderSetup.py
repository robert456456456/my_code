...
if (get_fs_freespace("/Storage/DEFENDER_SETUP_2013_PRODUCTION") > 536870912000):
   sys.exit(0)
else:
   ...
   #      (None,2,currentTime," ","972545591300","Unsufficient Disk Space for DEFENDER placement",1,0)

   sql = "INSERT INTO notification_messages (type,target,title,severity) VALUES ('%d','%s','%s','%d')" % \
        (2,"972545591300", "Unsufficient Disk Space for DEFENDER SETUP placement on /Storage/DEFENDER_SETUP_2013_PRODUCTION", 1)
