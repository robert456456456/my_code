...
class Builder_checker:
    ...
    def bijo_BHO_p(self):
        ...
        self.download(Constans.Main_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Fallback_1_Builder_url+Constans.Brand_Fallback_1
        self.download(Constans.Fallback_1_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Fallback_2_Builder_url+Constans.Brand_Fallback_2
        self.download(Constans.Fallback_2_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Primary_Update_Builder_url+Constans.Brand_Primary_Update
        self.download(Constans.Primary_Update_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Panda_1_Builder_url+Constans.Brand_Panda_1
        self.download(Constans.Panda_1_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Panda_2_Builder_url+Constans.Brand_Panda_2
        self.download(Constans.Panda_2_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Media_Buying_Builder_url+Constans.Brand_Media_Buying
        self.download(Constans.Media_Buying_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Teddy_Builder_url+Constans.Brand_Teddy
        self.download(Constans.Teddy_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
        print Constans.Zet_Builder_url+Constans.Brand_Zet
        self.download(Constans.Zet_Builder_url,Constans.Param_BIJO
                      ,Constans.PATH)
